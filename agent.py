...
class Agent:
    ...
    def __init__(self):
        ...
        self.model = Linear_QNet(8 + 8 * VISION_RANGE, 256, 3)
    ...
    def get_state(self, game):
        ...
        for i in range(1, VISION_RANGE + 1):
            ...
            point_l = Point(head.x - BLOCK_SIZE * i, head.y)
            point_r = Point(head.x + BLOCK_SIZE * i, head.y)
            point_u = Point(head.x, head.y - BLOCK_SIZE * i)
            point_d = Point(head.x, head.y + BLOCK_SIZE * i)

            point_lu = Point(head.x - BLOCK_SIZE * i, head.y - BLOCK_SIZE * i)
            point_ru = Point(head.x + BLOCK_SIZE * i, head.y - BLOCK_SIZE * i)
            point_ld = Point(head.x - BLOCK_SIZE * i, head.y + BLOCK_SIZE * i)
            point_rd = Point(head.x + BLOCK_SIZE * i, head.y + BLOCK_SIZE * i)
